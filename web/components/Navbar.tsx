				...
				<div className='flex items-center justify-between h-16'>
					...
					<div className='hidden md:flex items-center space-x-4 lg:space-x-6'>
						...
						<div className='relative group'>
							...
							{/* Tooltip */}
							<div className='marketplace-tooltip absolute left-1/2 -translate-x-1/2 top-full mt-2 px-3 py-2 rounded-lg text-xs font-medium whitespace-nowrap opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 pointer-events-none z-50'>
								Peer-to-peer trading & verified listings coming soon
								<div className='marketplace-tooltip-arrow absolute left-1/2 -translate-x-1/2 -top-1'></div>
							</div>
						</div>
						<Link
							href='/binder'
